...
def create_table():  # Función para crear la tabla
    conn = psycopg2.connect("dbname = 'felipe_db' user = 'felipe12.reina' password = 'coki21Ta.' host = 'localhost' port = '5432' ")  # Conexión con la base de datos
...
def insert(item, quantity, price):  # Función para insertar datos
    conn = psycopg2.connect("dbname = 'felipe_db' user = 'felipe12.reina' password = 'coki21Ta.' host = 'localhost' port = '5432' ")
    cur = conn.cursor()
