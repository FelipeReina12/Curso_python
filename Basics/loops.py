...
for value in phone_numbers.keys():  #Recorre las claves del diccionario
    print(value)  #Imprime los valores del diccionario
for key in phone_numbers.values():  #Recorre los valores del diccionario
    print(key)  #Imprime las claves del diccionario
#Para imprimir valores y keys del diccionario 
for key, value in phone_numbers.items():
    print(f"{key}: {value}")  #Imprime los valores y las claves del diccionario 
